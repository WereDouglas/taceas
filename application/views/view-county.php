                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">   <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        if (is_array($county) && count($county)) {
                                            foreach ($county as $loop) {
                                                ?>  
                                                <tr class="odd">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">             
                        <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/county/create'  method="post">
                            <div class=" item form-group">
                                <label class="control-label col-md-12 col-sm-12 col-xs-12">District</label>
                                <div class="col-md-12 col-sm-12 col-xs-12">

                                    <input class="easyui-combobox form-control" name="districtID" id="districtID" style="width:100%;height:26px" data-options="
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $("td[contenteditable=true]").blur(function () {
                ...
                var value = $(this).text();
                $.post('<?php echo base_url() . "index.php/county/update/"; ?>', field_id + "=" + value, function (data) {
                    if (data != '')
                    {
                        message_status.show();
