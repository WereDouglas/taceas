        ...
        <div class="col-lg-2">
            <a href="javascript:void(0);" class="add_user" data-toggle="modal" data-target="#myModal"> 
                <div class="alert alert-success text-center">
                    <i class="fa fa-user-md fa-3x"></i>&nbsp;<b><?php echo count($customers);?> </b>Add new customer
            ...
            <div class="col-md-12">
                <div class="block-web">
                    <div class="header">
                        ...
                        <h3 class="content-header">Customers</h3>
                                    ...
                                    if (is_array($customers) && count($customers)) {
                                        foreach ($customers as $loop) {
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td ><?php echo $loop->agent; ?></td>

                                                <td id="created:<?php echo $loop->id; ?>" contenteditable="true"><?php echo $loop->created; ?></td>

                                                <td class="edit_td">
                                                    <a class="btn btn-danger btn-xs" href="<?php echo base_url() . "index.php/customer/delete/" . $loop->id; ?>"><li class="fa fa-trash-o">Delete</li></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">             
                    <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/customer/create'  method="post">
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $("td[contenteditable=true]").blur(function () {
                ...
                var value = $(this).text();
                $.post('<?php echo base_url() . "index.php/customer/update/"; ?>', field_id + "=" + value, function (data) {
                    if (data != '')
                    {
                        message_status.show();
