...
<div id="page-wrapper">
    ...
    <div class="row">
        <!-- Page Header -->
        <div class="col-lg-12">
            <h2 class="page-header">Package Inventory</h2>
            <!--End Page Header -->        
        </div>
                                            ...
                                            foreach ($dis as $loop) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td id="quantity:<?php echo $loop->id; ?>" contenteditable="true">
                                                        ...
                                                        ?>
                                                        <font color="<?php echo $color; ?>">  <?php echo $loop->qty; ?></font>
                                                    </td>                                                   

                                                    <td class="edit_td">
                                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url() . "index.php/inventory_package/delete/" . $loop->id; ?>"><li class="fa fa-trash-o">Delete</li></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Add Inventory Package</h4>
                    </div>
                    <div class="modal-body">             
                        <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/inventory/create_package'  method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="qty" placeholder="Quantity" id="qty" required class="form-control"/>
