                        ...
                        if (is_array($dis) && count($dis)) {
                            foreach ($dis as $loop) {
                                ...
                                <tr class="odd">
                                    ...
                                    <td id="previous<?php echo $loop->id; ?>" contenteditable="true">
                                        <?php echo $loop->previous; ?>
                                    </td>
                                    <td id="current:<?php echo $loop->id; ?>" contenteditable="true">
                                        <?php echo $loop->current; ?>
                                    </td>
