                                        ...
                                        if (is_array($regions) && count($regions)) {
                                            foreach ($regions as $loop) {
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="edit_td">
                                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url() . "index.php/region/delete/" . $loop->id; ?>"><li class="fa fa-trash-o">Delete</li></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">             
                        <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/region/create'  method="post">
