                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">   <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        if (is_array($parish) && count($parish)) {
                                            foreach ($parish as $loop) {
                                                ?>  
                                                <tr class="odd">
                                                    ...
                                                    <td >
                                                        <?php echo $loop->subcounty; ?>
                                                    </td>

                                                    <td class="edit_td">
                                                        <a class="btn btn-danger btn-xs" href="<?php echo base_url() . "index.php/parish/delete/" . $loop->id; ?>"><li class="fa fa-trash-o">Delete</li></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">             
                        <form id="station-form" parsley-validate novalidate role="form" class="form-horizontal" name="login-form" enctype="multipart/form-data"  action='<?= base_url(); ?>index.php/parish/create'  method="post">
                            <div class=" item form-group">
                                <label class="control-label col-md-12 col-sm-12 col-xs-12">Sub county</label>
                                <div class="col-md-12 col-sm-12 col-xs-12">

                                    <input class="easyui-combobox form-control" name="subcountyID" id="subcountyID" style="width:100%;height:26px" data-options="
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $("td[contenteditable=true]").blur(function () {
                ...
                var value = $(this).text();
                $.post('<?php echo base_url() . "index.php/parish/update/"; ?>', field_id + "=" + value, function (data) {
                    if (data != '')
                    {
                        message_status.show();
