...
class Region extends CI_Controller {
    ...
    public function index() {
        ...
        $query = $this->Md->query("SELECT * FROM region");
        ...
        $this->load->view('view-region', $data);
    }
    ...
    public function create() {
        ...
        if ($this->input->post('name') != "") {
            ...
            $comp = array('name' => $this->input->post('name'));
            $this->Md->save($comp, 'region');
        ...
        if (!empty($_POST)) {
            ...
            foreach ($_POST as $field_name => $val) {
                ...
                if (!empty($user_id) && !empty($field_name) && !empty($val)) {
                    ...
                    $this->Md->update_dynamic($user_id, 'id', 'region', $task);
                    echo "Updated";
                } else {
    ...
    public function delete() {
        ...
        $query = $this->Md->cascade($id, 'region', 'id');
